...
#All Features
#df <- subset(gy, select = c(Pregnancies, Glucose,BloodPressure, SkinThickness,Insulin,DiabetesPedigreeFunction ,BMI, Age,Outcome))

#Without Insulin/DPF
#df <- subset(gy, select = c(Pregnancies, Glucose,BloodPressure, SkinThickness,BMI, Age,Outcome))

#Without Pregnancies/Insulin/DPF
#df <- subset(gy, select = c(Glucose,BloodPressure, SkinThickness,BMI, Age,Outcome))

#Without Age/Insulin/DPF
df <- subset(gy, select = c(Pregnancies, Glucose,BloodPressure, SkinThickness,BMI,Outcome))
